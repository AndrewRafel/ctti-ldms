 ...
 */
final class Version20230425184545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE news (id INT AUTO_INCREMENT NOT NULL, heading VARCHAR(255) NOT NULL, content VARCHAR(255) NOT NULL, date VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
